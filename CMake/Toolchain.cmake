...
if (BUILD_HOST)
    ...
    set_property(CACHE TOOLCHAIN PROPERTY STRINGS "gccarmemb")
endif ()
...
add_custom_target(fix_dependencies
    COMMAND java -jar  ../software/CMake/nordicPlus.jar -l -n SDK_ROOT -E -f ../software/fix.cmake ${SDK_ROOT})
